...
const NewsCard = ({ article }) => {
  ...
  return (
    ...
    >
      <img
        src={urlToImage? urlToImage : "https://tse3.mm.bing.net/th/id/OIP.u5FXGNMuIWLUWBSkLPxTXwHaGP?cb=12&rs=1&pid=ImgDetMain&o=7&rm=3"}
        alt={title}
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">{description?.length > 100 ? 
        description.slice(0, 100) + "..." : description}</p>
            <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">
                <span> By  <span className="font-bold ">  {author || "Unknown"}</span>{" on "}</span>
